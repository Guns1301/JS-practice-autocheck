// Основы ООП : класс, конструктор, прототип (чертеж), /экземпляр (объект), /интерфейс(набор свойств и методов)

const Car1 = function({brand,model,price}) { //можно передать ({brand,model,price})
